"""Template helpers for rendering forms in the ui idiom.
...
# Widget class → the ui control class it should render as.
...
def _style(field: BoundField, extra_class: str = "") -> BoundField:
    """Merge ui classes and validation state into the widget's attrs."""
...
def ui_widget(field: BoundField, extra_class: str = "") -> str:
    """Render just the control, already carrying its ui classes."""
