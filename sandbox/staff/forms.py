...
def staff_members() -> QuerySet[User]:
...
def queue_status_choices(*, include_any: bool = False) -> list[tuple[str, str]]:
    """Status choices worded from the review team's side of the conversation.
...
class TeamMemberChoiceField(forms.ModelChoiceField):
    """A staff picker that reads like the rest of the console.
